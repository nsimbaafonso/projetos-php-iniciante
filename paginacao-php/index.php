...
$limit = 2;//limit mostra uma quantidade específico de registros por páginas
$page_interval = 2;//mostra o intervalo de páginas
...
<body>
	...
	<p>
		...
		$last_page = min($page_num, $page + $page_interval);
