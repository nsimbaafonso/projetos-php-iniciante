...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25/02/2024 às 13:21
...
-- Banco de dados: `wd43`
--
CREATE DATABASE IF NOT EXISTS `wd43` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `wd43`;
...
--
-- Criação: 25/02/2024 às 12:13
-- Última atualização: 25/02/2024 às 12:15
--
